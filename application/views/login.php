...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <img src="<?php echo base_url('assets') ?>/dist/img/logo.jpg" alt="Responsive image" class="img-fluid">
      <a href="#">
        <div class="badge badge-danger text-white" style="width: 8rem;"><b>Parkiran</b></div>Telkom
      </a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
